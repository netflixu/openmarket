...
- 로그인/로그아웃 : 토큰 기반 로그인/로그아웃을 구현했습니다. Access Token은 localStorage에, Refresh Token은 sessionStorage에 저장해 사용했습니다.
...
- 임영후 : 서로 격려하며 프로젝트를 끝까지 마무리하는 것을 목표로 했고, 계획대로 잘 마무리되어 만족스럽습니다. 코드 리뷰를 통해 서로의 부족한 부분을 보완하고 기술적인 내용을 함께 배우는 시간이었습니다.
- 허지은
- 김규호
- 안민
